...
than four and you are guessing at where the answer is rather than thinking. They
run three at a time, so a fourth waits for one of the first three to finish.
